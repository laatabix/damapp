...
/**
 * This is the item provider adapter for a {@link damapp.DataEntity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataEntityItemProvider extends DamappEntityItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataEntity_uses_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataEntity_uses_feature", "_UI_DataEntity_type"),
				 DamappPackage.Literals.DATA_ENTITY__USES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DamappPackage.Literals.DATA_ENTITY__ATTRIBUTES);
			childrenFeatures.add(DamappPackage.Literals.DATA_ENTITY__OPERATIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DamappPackage.Literals.DATA_ENTITY__ATTRIBUTES,
				 DamappFactory.eINSTANCE.createAttribute()));

		newChildDescriptors.add
			(createChildParameter
				(DamappPackage.Literals.DATA_ENTITY__OPERATIONS,
				 DamappFactory.eINSTANCE.createOperation()));
	}
